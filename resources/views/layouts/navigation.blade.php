        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('cabinet.vacancies')" :active="request()->routeIs('cabinet.vacancies')">
                        {{ __('Job Vacancies') }}
                    </x-nav-link>
                    <x-nav-link :href="route('cabinet.responses')" :active="request()->routeIs('cabinet.responses')">
                        {{ __('Job Responses') }}
                    </x-nav-link>
                </div>
            </div>
